...
public class BaseTransaction {
    ...
    public static class Builder {
        ...
        public BaseTransaction build() {
            ...
            return new BaseTransaction(symbol, transactionType, price, quantity);
        }
    }

    private BaseTransaction(final String symbol, final TransactionType transactionType, final double price, final long quantity) {
        this.symbol = symbol;
        this.transactionType = transactionType;
        this.price = price;
        this.quantity = quantity;
